...
export const test = base.extend<{alertsPage: AlertsPage, dashboardPage: DashboardPage, datasetsPage: DatasetsPage, datePicker: DatePicker, dependenciesPage: DependenciesPage, infrastructurePage: InfrastructurePage, landingPage: LandingPage, logsExplorerPage: LogsExplorerPage, observabilityPage: ObservabilityPage, servicesPage: ServicesPage, tracesPage: TracesPage}>
({
