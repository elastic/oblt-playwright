...
for file in $FILES; do
    ...
    curl -XPOST "$REPORT_CLUSTER_ES/$REPORT_CLUSTER_INDEX/_doc/?pretty" -H "Authorization: ApiKey $REPORT_CLUSTER_API_KEY" -H "Content-Type: application/json" --data-binary "@$file"
done