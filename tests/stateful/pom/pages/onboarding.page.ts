...
export default class OnboardingPage {
    ...
    public readonly useCaseLogs = () => this.page.locator('xpath=//div[@data-test-subj="observabilityOnboardingUseCaseCard-logs"]//input[@type="radio"]');
    ...
    private readonly kubernetesElasticAgent = () => this.page.getByTestId('integration-card:kubernetes-quick-start');
